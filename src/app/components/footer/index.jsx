      ...
      <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
        <div className="sm:flex sm:items-center sm:justify-between">
          <div className="text-teal-600">
            <h2 className="text-2xl font-bold">Next Crew</h2>
            <p className="mt-2 text-gray-600">
              Your trusted partner in Human Resource solutions and manpower services.
            </p>
          </div>
          ...
          <ul className="mt-8 flex justify-start gap-6 sm:mt-0 sm:justify-end">
            ...
            <li>
              <a
                href="mailto:contact@nextcrew.com"
                className="text-gray-700 transition hover:opacity-75"
              >
                <span className="sr-only">Email</span>
                <EnvelopeIcon className="size-6" fill="currentColor" aria-hidden="true" />
              </a>
            </li>
          </ul>
        </div>
        ...
        <div className="flex justify-between items-center border-t border-gray-100 pt-8">
          ...
          <div className="text-sm text-gray-500">
            ...
            <div className='text-align-center text-gray-500 mt-2'>
              <a href='https://www.kirandev.in' target='_blank'>www.kirandev.in</a>
            </div>
          </div>
        </div>
      </div>
